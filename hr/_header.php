  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">
        <span class="">Hello <?php echo $fname1.' '.$surname1; ?> (<?php echo strtoupper($dept).' Department'; ?>)</span>
        <br><br>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <br><br>
        <li><a href="hr_view.php"><i class="fa fa-users">&nbsp;View Staff</i></a></li>
        <li><a href="hr_add.php"><i class="fa fa-plus">&nbsp;Add Staff</i></a></li>
        <!-- <li><a href="hr_misconduct.php"><i class="fa fa-spoon">&nbsp;Add Misconduct</i></a></li> -->
    </ul>
    </div>
  </div>
</nav>
