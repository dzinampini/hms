...
<div class="container">
	...
	<h1 align="">Patient <?php echo $hn = $_GET['id']; ?> Hospital Bill</h1> 
	<div class="row">
		<div class="col-md-2">
		</div>
		<div class="col-md-8">
...
$update_bill = "UPDATE `opd_patients` SET `bill`='$total_bill' WHERE `opd_id`='$hn'"; 

$rs = mysqli_query($con, $update_bill);
