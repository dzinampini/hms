  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">
        <span class="">Hello <?php echo $fname1.' '.$surname1; ?> (<?php echo 'OutPatients Department'; ?>)</span>
        <br><br>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <br><br>
        <li><a href="observations.php"><i class="fa fa-stethoscope">&nbsp;Observations</i></a></li>
        <li><a href="consultation.php"><i class="fa fa-heartbeat">&nbsp;Consultation</i></a></li>
    </ul>
    </div>
  </div>
</nav>
